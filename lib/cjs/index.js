...
var javascriptSdk = require('@flat-peak/javascript-sdk');
...
async function connectTariff( appParams, providerHooks, credentials, inputParams) {
  ...
  const service = new javascriptSdk.FlatpeakService(api_url, publishable_key, (message) => {
    if (logger) {
...
exports.integrateProvider = integrateProvider;
